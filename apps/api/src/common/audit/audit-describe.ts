...
export const AUDIT_PHASE: Record<string, string> = {
  ...
  login: "other", auth: "other", auth_refresh: "other", logout: "other", staff: "other",
};
...
const ENTITY_AR: Record<string, string> = {
  ...
  login: "تسجيل الدخول", auth: "تسجيل الدخول", auth_refresh: "تجديد الجلسة", logout: "تسجيل الخروج", staff: "الموظف",
};
...
const SELF_DESCRIBING = new Set(["deal_convert", "slip_rfq_sent", "firm_order", "proposal", "policy_technical", "policy_finance", "policy_approval_step", "policy_cancellation", "commission_receipt", "credit_note_refund", "insurer_settlement", "producer_settlement", "employee_commission_settlement", "compliance", "verification", "login", "auth", "auth_refresh", "logout"]);
