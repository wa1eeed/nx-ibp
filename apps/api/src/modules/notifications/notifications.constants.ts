...
export const NOTIFICATION_TYPES: readonly NotificationTypeDef[] = [
  ...
  { key: "cover_note_issued", audience: "client", module: null, name: "مذكرة تغطية مؤقتة", subject: "صدرت مذكرة تغطيتك المؤقتة", body: "صدرت مذكرة تغطية مؤقتة ({ref}) تُثبت تغطيتك حتى إصدار الوثيقة. تجدها في بوّابتك.", subjectEn: "Your cover note has been issued", bodyEn: "A temporary cover note ({ref}) confirming your coverage until the policy is issued is now in your portal.", email: true, sms: false },
  ...
  { key: "installment_upcoming", audience: "client", module: null, name: "قسط يقترب استحقاقه", subject: "تذكير بقسط يقترب استحقاقه", body: "قسطك رقم {seq} بمبلغ {amount} ريال يستحقّ بعد {days} أيام بتاريخ {dueDate}. يُرجى الاستعداد للسداد.", subjectEn: "Upcoming installment reminder", bodyEn: "Your installment no. {seq} of SAR {amount} is due in {days} days on {dueDate}. Please be ready to pay.", email: true, sms: true },
