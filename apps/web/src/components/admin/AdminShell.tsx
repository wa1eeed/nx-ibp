...
import { ShieldCheck, Building2, Package, BarChart3, Bell, LogOut, Headset, ScrollText, CreditCard, DatabaseZap } from "lucide-react";
...
const NAV = [
  ...
  { key: "crRegistry", href: "/admin/cr-registry", icon: DatabaseZap },
