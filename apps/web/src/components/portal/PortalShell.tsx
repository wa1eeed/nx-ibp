...
import { ShieldCheck, LayoutDashboard, FileCheck2, FileText, ClipboardList, Receipt, FolderOpen, UserCog, LogOut, FileSignature, CalendarClock } from "lucide-react";
...
const NAV = [
  ...
  { key: "proposals", href: "/portal/proposals", icon: FileSignature },
  { key: "claims", href: "/portal/claims", icon: ClipboardList },
  { key: "statement", href: "/portal/statement", icon: Receipt },
  { key: "installments", href: "/portal/installments", icon: CalendarClock },
