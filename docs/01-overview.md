...
### محورا التحكم
1. **المستخدمون (Seats):** **بلا سقف من الباقة** (`Plan.seatLimit = null`) — التسعير لكل مستخدم فعلي نشِط، مع احتساب تناسبي (Proration) عند الإضافة وسط الدورة.
