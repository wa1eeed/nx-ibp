...
- **التطبيق (صفحة المالية نموذجًا):** كل أزرار التنفيذ محكومة بـ`finance:edit` — فمثلًا **مدير الالتزام (المالية قراءة فقط)** لا يرى أزرار التسوية/التقسيط/المرتجع/القيود. تُوسَّع بقيّة الصفحات تدريجيًا بنفس النمط.
