...
| **المجالية** | [`src/modules/`](../apps/api/src/modules) | منطق الأعمال: auth, rbac, catalog, clients, requests, underwriting, production, finance, documents, service, claims, renewals, verification, **platform**, **portal**, staff, health |
