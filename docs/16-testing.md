...
**+ الباقات والتسجيل:** `signup` (كتالوج عام `/signup/plans` بسعر/مستخدم + توفير · onboarding: تحقّق الرقم الموحد 10/الجوال 05 · قصّ المقاعد لحدّ الباقة) · `plan-seats` (**تعديل السعر الشهري/السنوي والتجربة من السوبر أدمن ⇒ يظهر في الكتالوج العام مع نسبة التوفير**).
...
```
المتوقّع: `Test Suites: 36 passed`, `Tests: 233 passed`.
