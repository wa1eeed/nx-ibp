...
| [`finance.e2e-spec.ts`](../apps/api/test/finance.e2e-spec.ts) | 7 | إصدار من طلب AWARDED، **اعتماد مالي يولّد قيد JRV مزدوجاً متوازناً** + فاتورة، **دورة التحصيل** (سند قبض/جزئي/409/مسدَّد + كشف حساب)، **الإلغاء** (قسط مُرتجَع نسبةً + إشعار دائن)، **تسوية المؤمِّن** (PYV + تجاوز 409 + ميزان مراجعة متوازن) |
...
**الإجمالي: 221 اختباراً (34 ملفاً).**
