...
**+ البريد والهوية البصرية:** `email-branding` (13: الهوية الافتراضية/حفظ لون واسم/لون غير صالح 400/**رفع شعار ⇒ رابط عام يخدمه بلا مصادقة**/عزل الهوية/صلاحية 403 · البريد unconfigured⇒fallback/**وضع الردود فقط بلا مفتاح**/حفظ⇒pending مع **إخفاء المفتاح**/تحقّق⇒**ترقية آلية لوضع tenant**/صلاحية 403).
...
**الإجمالي: 274 اختباراً (40 ملفاً).**
