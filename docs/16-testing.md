...
**+ سجلّ المنتِجين:** `producers` (5: منع غير المالية من الإنشاء · إنشاء برمز PRD- · **ربط وثيقة بمنتِج ⇒ احتساب حصّته آليًا بنسبته** · تسوية PYV تُنقص المتبقّي/تمنع التجاوز 409/المكتتب 403 · العزل بين المستأجرين).
