...
| [`finance.e2e-spec.ts`](../apps/api/test/finance.e2e-spec.ts) | 6 | إصدار من طلب AWARDED، **اعتماد مالي يولّد قيد JRV مزدوجاً متوازناً** + فاتورة ضريبية، **دورة التحصيل** (سند قبض/جزئي/409/مسدَّد + كشف حساب)، **الإلغاء** (قسط مُرتجَع نسبةً + إشعار دائن + CANCELLED) |
...
**الإجمالي: 219 اختباراً (34 ملفاً).**
