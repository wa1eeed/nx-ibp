...
[`test/finance.e2e-spec.ts`](../apps/api/test/finance.e2e-spec.ts): الشلال الكامل، منع RBAC (المبيعات/المحاسب من الإنتاج، المكتتب من المالية)، **توازن القيد** (مدين = دائن)، **اتجاه الفاتورة** (عمولة على المؤمِّن + رسوم خدمة على العميل بحساب 04020) و**الإلغاء** (قسط مُرتجَع + CNP + CNC)، **دورة التحصيل** (سند قبض/جزئي/409) و**تسوية المؤمِّن** (PYV + ميزان مراجعة متوازن)، **القيود اليدوية** (توازن/حساب ورقة/RBAC)، **عمولات الموظفين** (متوقّعة/مستحقّة/صرف بحدّ)، **خطة التقسيط** (تقسيم = الإجمالي · شلال بالأقدم استحقاقًا · ترحيل تحصيل سابق · حواجز 400/409/403)، **المعالجة الضريبية** (ضريبة القسط 15%، ضريبة العمولة/الرسوم كـ Output VAT)، والعزل. الإجمالي **e2e 289/289**.
