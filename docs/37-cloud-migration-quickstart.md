...
> **السجل التجاري (البيانات المفتوحة):** لا يحتاج أيّ متغيّر — اللقطة مضمَّنة في الصورة ويحمّلها الـentrypoint تلقائيًّا عند أول نشر (مرّة واحدة). التفاصيل: [docs/23](./23-government-verification.md).
